...
scoreboard players add @s dnd.dummy 0
execute if entity @s[scores={dnd.dummy=0..2}] run function dnd:entity/ambermancer/line_of_sight/start
scoreboard players add @s[scores={dnd.dummy=0..}] dnd.dummy 1
...
execute if entity @s[scores={dnd.dummy=3}] run function dnd:entity/ambermancer/spell_end
