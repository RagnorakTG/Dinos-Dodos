...
execute if score dnd.temp_0 dnd.dummy matches 1.. run loot spawn ~ ~ ~ loot dnd:items/genome_modifier
execute if entity @s[tag=dnd.genome_modifier] run particle minecraft:item furnace{CustomModelData:400005} ~ ~ ~ 0.2 0.2 0.2 0.05 20 normal
