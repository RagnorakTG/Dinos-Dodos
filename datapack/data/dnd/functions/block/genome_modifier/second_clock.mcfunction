...
execute if data block ~ ~ ~ Items[{Slot:0b}].tag.dnd.identifier run data modify storage dnd:storage root.genome_temp set from block ~ ~ ~ Items[{Slot:0b}].tag.dnd.identifier
execute if data block ~ ~ ~ Items[{Slot:6b}].tag.dnd.identifier run data modify storage dnd:storage root.genome_temp set from block ~ ~ ~ Items[{Slot:6b}].tag.dnd.identifier
execute if data block ~ ~ ~ Items[{Slot:0b}].tag.dnd.identifier store success score temp dnd.dummy run data modify storage dnd:storage root.genome_temp set from block ~ ~ ~ Items[{Slot:0b}].tag.dnd.identifier
execute if data block ~ ~ ~ Items[{Slot:6b}].tag.dnd.identifier store success score temp dnd.dummy run data modify storage dnd:storage root.genome_temp set from block ~ ~ ~ Items[{Slot:6b}].tag.dnd.identifier
