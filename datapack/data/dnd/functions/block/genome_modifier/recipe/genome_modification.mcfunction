...
execute store result score input_1 dnd.math run scoreboard players get output dnd.math
...
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.armor double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.armor_toughness double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.attack_damage double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.attack_knockback double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.attack_speed double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.flying_speed double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.follow_range double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.knockback_resistance double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.luck double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.max_health double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.movement_speed double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.horse_jump double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/add
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.entity.genome.zombie_reinforcements double 0.01 run scoreboard players get output dnd.math
...
function dnd:technical/math/divide
execute store result score input_2 dnd.math run scoreboard players get output dnd.math
