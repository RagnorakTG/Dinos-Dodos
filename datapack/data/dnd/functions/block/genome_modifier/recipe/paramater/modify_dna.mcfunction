...
execute if data block ~ ~ ~ Items[{Slot:0b}].tag.dnd.storage{modified:1} if data block ~ ~ ~ Items[{Slot:6b}].tag.dnd.storage{modified:1} run scoreboard players set temp_0 dnd.dummy 0
# Run Recipe
