...
execute if score temp_0 dnd.dummy matches 1.. run loot spawn ~ ~ ~ loot dnd:items/dna_combinator
execute if entity @s[tag=dnd.dna_combinator] run particle minecraft:item furnace{CustomModelData:400004} ~ ~ ~ 0.2 0.2 0.2 0.05 50 normal
