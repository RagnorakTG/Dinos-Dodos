...
## Entity
execute if score count dnd.dummy matches 0 if score DNA? dnd.dummy matches 1 if score accuracy1 dnd.dummy matches 100 if score accuracy2 dnd.dummy matches 100 if score temp dnd.dummy matches 1 if score temp2 dnd.dummy matches 1 unless score modified dnd.dummy matches 1 if score doHybridization dnd.config matches 1 run function dnd:block/dna_combinator/hybrid_entity
## Plant
execute if score count dnd.dummy matches 0 if score DNA? dnd.dummy matches 1 if score accuracy1 dnd.dummy matches 100 if score accuracy2 dnd.dummy matches 100 if score temp dnd.dummy matches 0 if score temp2 dnd.dummy matches 0 unless score modified dnd.dummy matches 1 if score doHybridization dnd.config matches 1 run function dnd:block/dna_combinator/hybrid_plant
