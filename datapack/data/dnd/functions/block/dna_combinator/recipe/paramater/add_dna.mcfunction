...
execute if score temp_0 dnd.dummy matches 0 if block ~ ~ ~ dispenser{Items:[{Slot:0b,tag:{dnd:{id:"dna",storage:{accuracy:100}}}}]} run scoreboard players set temp_0 dnd.dummy 1
execute if score temp_0 dnd.dummy matches 0 if block ~ ~ ~ dispenser{Items:[{Slot:6b,tag:{dnd:{id:"dna",storage:{accuracy:100}}}}]} run scoreboard players set temp_0 dnd.dummy 1
