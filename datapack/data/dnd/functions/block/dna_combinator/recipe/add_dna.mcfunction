...
execute store result score temp dnd.dummy run data get block ~ ~ ~ Items[{Slot:0b}].tag.dnd.storage.accuracy
execute store result score temp2 dnd.dummy run data get block ~ ~ ~ Items[{Slot:6b}].tag.dnd.storage.accuracy
...
execute store result block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.accuracy int 1 run scoreboard players get temp dnd.dummy
...
## Yellow Name
execute store result score temp dnd.dummy run data get block ~ ~ ~ Items[{Slot:5b}].tag.dnd.storage.accuracy
