...
execute if entity @s[predicate=dnd:block/check_spawner_item/block/amber_bud] run function dnd:block/amber_bud/break

# Kill EXP Orbs
execute if entity @s[predicate=dnd:block/check_spawner_item/kill_orbs] align xyz run kill @e[type=experience_orb,dx=0]
