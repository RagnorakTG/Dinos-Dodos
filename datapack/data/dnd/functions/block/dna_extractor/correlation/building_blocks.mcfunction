...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraft:dark_oak_sapling",generation:600}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.dark_oak_sapling"}}
## crimson_stem
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraft:sponge",generation:2400}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.sponge"}}
## wet_sponge
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraft:tube_coral_block",generation:120}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.tube_coral_block"}}
## brain_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraftbrain_coral_block",generation:120}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.brain_coral_block"}}
## bubble_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraft:bubble_coral_block",generation:120}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.bubble_coral_block"}}
## fire_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraft:fire_coral_block",generation:120}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.fire_coral_block"}}
## horn_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{accuracy:100,id:"dna",plant:{id:"minecraft:horn_coral_block",generation:120}},lore:{"italic":false,"color":"gray","translate":"lore.dnd.structure.horn_coral_block"}}
