...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{comp_dna:"minecraft:sponge",accuracy:100,id:"dna",plant:{id:"minecraft:sponge",RegenRate:2400}},structure_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.sponge"}'],accuracy_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.item.accuracy","with":[100]}']}
## wet_sponge
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{comp_dna:"minecraft:coral",accuracy:100,id:"dna",plant:{id:"minecraft:tube_coral_block",RegenRate:120}},structure_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.tube_coral_block"}'],accuracy_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.item.accuracy","with":[100]}']}
## brain_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{comp_dna:"minecraft:coral",accuracy:100,id:"dna",plant:{id:"minecraftbrain_coral_block",RegenRate:120}},structure_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.brain_coral_block"}'],accuracy_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.item.accuracy","with":[100]}']}
## bubble_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{comp_dna:"minecraft:coral",accuracy:100,id:"dna",plant:{id:"minecraft:bubble_coral_block",RegenRate:120}},structure_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.bubble_coral_block"}'],accuracy_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.item.accuracy","with":[100]}']}
## fire_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{comp_dna:"minecraft:coral",accuracy:100,id:"dna",plant:{id:"minecraft:fire_coral_block",RegenRate:120}},structure_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.fire_coral_block"}'],accuracy_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.item.accuracy","with":[100]}']}
## horn_coral_block
data modify storage dnd:storage root.extractor set from block ~ ~ ~ Items[{Slot:3b}]
...
execute if score correlation dnd.dummy matches 0 run data modify storage dnd:storage root.extracted set value {id:{comp_dna:"minecraft:coral",accuracy:100,id:"dna",plant:{id:"minecraft:horn_coral_block",RegenRate:120}},structure_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.horn_coral_block"}'],accuracy_lore:['{"italic":false,"color":"gray","translate":"lore.dnd.item.accuracy","with":[100]}']}
