...
# Modify the Needle
execute if entity @e[distance=..5,nbt={HurtTime:10s},tag=!global.ignore] if score temp_0 dnd.dummy matches 1 run item modify entity @s weapon.mainhand dnd:item/needle
# Advancement
