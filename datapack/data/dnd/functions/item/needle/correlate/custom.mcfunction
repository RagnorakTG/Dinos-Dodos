...
## Dinosaur
# Acrocanthosaurus
execute if entity @s[tag=dnd.acrocanthosaurus] run data modify storage dnd:storage root.temp set value {id:{id:"dna_needle",storage:{accuracy:100,dna:{RegenRate:0,produce:{Primary:{id:"blank",Count:0b},Secondary:{id:"blank",Count:0b}}},entity:{id:"minecraft:acrocanthosaurus",identifier:"minecraft:bird",CustomEntity:1,genome:{},UniqueData:{},eggData:{hasEgg:1b,CustomEgg:1b,Age:-24000,id:"egg_block",HatchWhen:1,CustomModelData:405001,Block_CMD:401001,eggName:['{"italic":false,"color":"white","translate":"item.dnd.acrocanthosaurus_egg"}'],CustomEntityData:{BabyFeedItem:"dnd:meat",Tags:["dnd.acrocanthosaurus","dnd.dinosaur","dnd.aggressive"],DeathLootTable:"dnd:entity/acrocanthosaurus",EntityID:"dnd:acrocanthosaurus",EntityType:"wandering_trader",Models:{adult:{idle:400001,walking:400002},baby:{idle:400003,walking:400004}}}}}}},structureLore:['{"italic":false,"color":"gray","translate":"lore.dnd.structure.acrocanthosaurus"}']}
# Concavenator
