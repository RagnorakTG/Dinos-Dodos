...
execute store result score @s rag.math2 run data get entity @s Inventory[{Slot:-106b}].tag.RagDurability 1
execute store result score @s rag.math run data get entity @s Inventory[{Slot:-106b}].tag.RagDamage 1
...
# Give new Item
execute as @s run loot replace entity @s weapon.offhand 1 mine ~ 0 ~ minecraft:diamond_pickaxe{rag:{Tags:["nbt_modifier"]}}

# Remove Block
execute as @s[nbt={Dimension:-1}] run setblock ~ 0 ~ bedrock
execute as @s[nbt={Dimension:0}] run setblock ~ 0 ~ bedrock
execute as @s[nbt={Dimension:1}] run setblock ~ 0 ~ air
