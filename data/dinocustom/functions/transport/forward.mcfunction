...
execute if block ^ ^3 ^0 #minecraft:jeep_move_through if block ^0.5 ^3 ^0 #minecraft:jeep_move_through if block ^-0.5 ^3 ^0 #minecraft:jeep_move_through if block ^ ^3 ^1 #minecraft:jeep_move_through if block ^0.5 ^3 ^1 #minecraft:jeep_move_through if block ^-0.5 ^3 ^1 #minecraft:jeep_move_through if block ^ ^3 ^2 #minecraft:jeep_move_through if block ^0.5 ^3 ^2 #minecraft:jeep_move_through if block ^-0.5 ^3 ^2 #minecraft:jeep_move_through if block ^ ^3 ^3 #minecraft:jeep_move_through if block ^0.5 ^3 ^3 #minecraft:jeep_move_through if block ^-0.5 ^3 ^3 #minecraft:jeep_move_through run tag @s add 4
...
execute if entity @s[tag=1_air,tag=!falling,tag=1_full,tag=2,tag=3,tag=4] run tp @s ^ ^ ^0.4
execute if entity @s[tag=1_air,tag=falling,tag=1_full,tag=2,tag=3,tag=4] run tp @s ^ ^-0.1 ^0.4

execute if entity @s[tag=1_air,tag=plus_1,tag=2,tag=3,tag=4] run tp @s ^ ^1.2 ^2.2
execute if entity @s[tag=1_air,tag=1_half,tag=2,tag=3,tag=4] run tp @s ^ ^.8 ^2.2
