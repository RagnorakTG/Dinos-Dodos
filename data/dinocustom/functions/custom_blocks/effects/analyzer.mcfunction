...
# Replace Head
execute as @s[tag=analyzer,tag=faced,tag=!replaced] at @s run replaceitem entity @s armor.head dispenser{CustomModelData:4040001}
...
## GUI
execute as @s[tag=!barMoving] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040005,RemoveFromInv:1b}
...
execute as @s[tag=barMoving,scores={analyzerBarTimer=100}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040005,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=200}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040006,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=300}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040007,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=400}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040008,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=500}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040009,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=600}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040010,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=700}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040011,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=800}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040012,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=900}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040013,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=1000}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040014,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=1100}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040015,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={analyzerBarTimer=1200}] at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040016,RemoveFromInv:1b}
