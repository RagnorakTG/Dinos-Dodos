...
#Amargasaurus
execute if block ~ ~ ~ barrel[facing=up]{CustomName: "{\"text\":\"DNA Extractor\"}", Items: [{Slot: 11b, id: "minecraft:bone", Count: 1b, tag: {CustomModelData: 3, display: {Name: "{\"translate\":\"Amargasaurus Bone\",\"color\":\"white\",\"italic\":false}"}}}], id: "minecraft:barrel"} run loot replace block ~ ~ ~ container.15 loot dinocustom:dna/amar_dna
execute if block ~ ~ ~ barrel[facing=up]{CustomName: "{\"text\":\"DNA Extractor\"}", Items: [{Slot: 11b, id: "minecraft:bone", Count: 1b, tag: {CustomModelData: 3, display: {Name: "{\"translate\":\"Amargasaurus Bone\",\"color\":\"white\",\"italic\":false}"}}}], id: "minecraft:barrel"} run replaceitem block ~ ~ ~ container.11 air
#Ankylosaurus
