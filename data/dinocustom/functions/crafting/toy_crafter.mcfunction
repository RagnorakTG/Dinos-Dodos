...
#GUI
execute as @s[type=armor_stand,tag=CustomBlock0] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:3}
...
execute as @s[type=armor_stand,tag=CustomBlock0] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.18 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4}
...
execute as @s[type=armor_stand,tag=CustomBlock0,tag=!notAirEast] at @s unless block ~1 ~ ~ air unless block ~1 ~ ~ chest run setblock ~ ~ ~ air destroy
execute as @s[type=armor_stand,tag=CustomBlock0,tag=!notAirEast] at @s unless block ~1 ~ ~ air unless block ~1 ~ ~ chest run setblock ~ ~ ~ chest[type=left]{CustomName:"{\"text\":\"toy_crafter\"}"} destroy
...
execute as @s[type=armor_stand,tag=CustomBlock0,tag=!AirEast] at @s if block ~1 ~ ~ air run setblock ~ ~ ~ air destroy
execute as @s[type=armor_stand,tag=CustomBlock0,tag=!AirEast] at @s if block ~1 ~ ~ air run setblock ~ ~ ~ chest[type=left]{CustomName:"{\"text\":\"toy_crafter\"}"} destroy
