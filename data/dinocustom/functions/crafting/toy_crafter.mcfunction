...
## Setup
# Face
execute as @s[tag=toy_crafter,tag=!faced] at @s if entity @a[limit=1,sort=nearest,y_rotation=135.1..180] run tag @s add north
execute as @s[tag=toy_crafter,tag=!faced] at @s if entity @a[limit=1,sort=nearest,y_rotation=-180..-135.1] run tag @s add north
execute as @s[tag=toy_crafter,tag=!faced] at @s if entity @a[limit=1,sort=nearest,y_rotation=-135..-45.1] run tag @s add east
execute as @s[tag=toy_crafter,tag=!faced] at @s if entity @a[limit=1,sort=nearest,y_rotation=-45..-0] run tag @s add south
execute as @s[tag=toy_crafter,tag=!faced] at @s if entity @a[limit=1,sort=nearest,y_rotation=0..45] run tag @s add south
execute as @s[tag=toy_crafter,tag=!faced] at @s if entity @a[limit=1,sort=nearest,y_rotation=45.1..135] run tag @s add west
execute as @s[tag=toy_crafter,tag=!faced] at @s run tag @s add faced
execute as @s[tag=toy_crafter,tag=faced,tag=north] at @s run tp @s ~ ~ ~ 0 0
execute as @s[tag=toy_crafter,tag=faced,tag=south] at @s run tp @s ~ ~ ~ 180 0
execute as @s[tag=toy_crafter,tag=faced,tag=east] at @s run tp @s ~ ~ ~ 90 0
execute as @s[tag=toy_crafter,tag=faced,tag=west] at @s run tp @s ~ ~ ~ -90 0
# Replace Head
execute as @s[tag=toy_crafter,tag=faced,tag=!replaced] at @s run replaceitem entity @s armor.head dispenser{CustomModelData:8}
execute as @s[tag=toy_crafter,tag=!replaced] at @s run tag @s add replaced
...
kill @e[type=item,nbt={Item:{id:"minecraft:barrel",tag:{display:{Name:'{"text":"toy_crafter"}'}}}}]

## stations
execute as @s[tag=toy_crafter,tag=faced] at @s run function dinocustom:crafting/stations/toy_crafter

##GUI
execute as @s at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4,RemoveFromInv:1b}
...
## Fix barrel
execute as @s[tag=!placed] at @s run setblock ~ ~ ~ barrel{CustomName:"{\"text\":\"toy_crafter\"}"} replace
execute as @s[tag=!placed] at @s run tag @s add placed
execute as @s[tag=toy_crafter] at @s run data merge entity @s {Fire:100}
