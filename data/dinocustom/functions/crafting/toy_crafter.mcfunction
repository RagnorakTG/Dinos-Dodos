...
# Replace Head
execute as @s[tag=toy_crafter,tag=faced,tag=!replaced] at @s run replaceitem entity @s armor.head dispenser{CustomModelData:4040008}
...
##GUI
execute as @s at @s if block ~ ~ ~ barrel run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:4040004,RemoveFromInv:1b}
