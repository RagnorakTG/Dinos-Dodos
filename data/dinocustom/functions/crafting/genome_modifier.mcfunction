...
# Replace Head
execute as @s[tag=CustomBlock1,tag=faced] at @s run replaceitem entity @s armor.head dispenser{CustomModelData:5}
# Register Crafting Station
execute as @s[tag=CustomBlock1,tag=faced] run tag @s add crafting_station
# Destroy Block
execute as @s[tag=CustomBlock1,tag=faced] at @s if block ~ ~ ~ air run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:dispenser",Count:1b,tag:{display:{Name:"{\"text\":\"Genome Modifier\",\"color\":\"white\",\"italic\":false}"},CustomModelData:5,genome_modifier:1,BlockEntityTag:{Items:[{Slot:0b,id:"minecraft:diamond",Count:1b,tag:{display:{Name:"{\"text\":\"genome_modifier\",\"color\":\"white\",\"italic\":false}"}}}]}}}}
...
## Fix Chest
execute as @s[tag=!placed] at @s run setblock ~ ~ ~ chest[type=left]{CustomName:"{\"text\":\"genome_modifier\"}"} replace
...
execute as @s[tag=barMoving,scores={extractorBar=100}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:65,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=200}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:66,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=300}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:67,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=400}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:68,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=500}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:69,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=600}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:70,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=700}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:71,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=800}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:72,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=900}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:73,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=1000}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:74,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=1100}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:75,RemoveFromInv:1b}
execute as @s[tag=barMoving,scores={extractorBar=1200}] at @s if block ~ ~ ~ chest run replaceitem block ~ ~ ~ container.0 barrier{display:{Name:"{\"text\":\"\"}"},CustomModelData:76,RemoveFromInv:1b}
