...
# Replace Item
execute as @s[tag=egret] run replaceitem entity @s armor.head granite{CustomModelData:7}
execute as @s[tag=egret,nbt={Motion:[0.0d, 0.0d, 0.0d]}] run replaceitem entity @s armor.head granite{CustomModelData:6}
# Make Non-hostile
