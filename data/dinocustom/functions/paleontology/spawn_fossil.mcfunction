...
execute as @s[tag=fossil,tag=!replaced,scores={Dinosaur_fossil=0}] run tag @s add 1
#Koolasuchus
...
execute as @s[tag=fossil,tag=!replaced,scores={Dinosaur_fossil=0}] run tag @s add 2
#Pachycephalosaurus
...
execute as @s[tag=fossil,tag=!replaced,scores={Dinosaur_fossil=0}] run tag @s add 3
#Spinosaurus
...
execute as @s[tag=fossil,tag=!replaced,scores={Dinosaur_fossil=0}] run tag @s add 4
#Velociraptor
...
execute as @s[tag=fossil,tag=!replaced,scores={Dinosaur_fossil=0}] run tag @s add 5
#Tags
