...
execute as @s[tag=fossil_formation,tag=!spawned,scores={Spawn_Fossil=1}] run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["fossil"],DisabledSlots:4144959,CustomName:"{\"text\":\"Fossil\"}"}
execute as @s[tag=fossil_formation,tag=!spawned,scores={Spawn_Fossil=2}] run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["fossil"],DisabledSlots:4144959,CustomName:"{\"text\":\"Fossil\"}"}
execute as @s[tag=fossil_formation,tag=!spawned,scores={Spawn_Fossil=2}] run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["fossil"],DisabledSlots:4144959,CustomName:"{\"text\":\"Fossil\"}"}
execute as @s[tag=fossil_formation,tag=!spawned,scores={Spawn_Fossil=3}] run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["fossil"],DisabledSlots:4144959,CustomName:"{\"text\":\"Fossil\"}"}
execute as @s[tag=fossil_formation,tag=!spawned,scores={Spawn_Fossil=3}] run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["fossil"],DisabledSlots:4144959,CustomName:"{\"text\":\"Fossil\"}"}
execute as @s[tag=fossil_formation,tag=!spawned,scores={Spawn_Fossil=3}] run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["fossil"],DisabledSlots:4144959,CustomName:"{\"text\":\"Fossil\"}"}
