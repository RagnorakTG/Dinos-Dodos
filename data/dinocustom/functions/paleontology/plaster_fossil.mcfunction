##Plaster
#Detect
execute as @s[tag=fossil,tag=!plastered] at @s if entity @a[distance=..5,scores={R_Click_Fossil=1..}] run clear @p[distance=..5] paper{CustomModelData:1} 1
...
execute as @s[tag=fossil,tag=!plastered] at @s if entity @a[distance=..5,scores={R_Click_Fossil=1..}] run scoreboard players set @p[distance=..5] R_Click_Fossil 0
...
#Do
execute as @a unless entity @e[tag=fossil,distance=..5] run scoreboard players set @s R_Click_Fossil 0
