...
execute as @s[tag=ankylosaurus_egg,tag=hatch] unless entity @e[tag=ankylosaurus_grounds,distance=..200] run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["ankylosaurus_grounds","grounds","herbivorous_grounds"]}
...
# Loot table
execute as @s[tag=ankylosaurus,tag=baby,tag=walking] run data merge entity @s {DeathLootTable:"dinocustom:mobs/dinosaur/meat/anky_meat"}
