...
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..1}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..2}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..3}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..4}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..5}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..6}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
execute if score Eggs Toggles matches 1 as @e[tag=velo_egg,scores={HatchEggs=2400..,EggAmmount=..7}] at @s run summon zombie ~ ~ ~ {NoGravity:0b,Silent:1b,NoAI:1b,Health:10f,IsBaby:0b,CanBreakDoors:0b,Tags:["dinosaur","velociraptor","infant"],CustomName:"{\"text\":\"Velociraptor\"}",ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:3}}],Attributes:[{Name:generic.maxHealth,Base:10}]}
