...
execute as @s[tag=tupandactylus_egg,tag=hatch] run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["tupandactylus_grounds","pterosaur_grounds","grounds","piscivorous_grounds"]}
