...
execute as @s[tag=velociraptor_egg,tag=hatch] run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,Tags:["velociraptor_grounds","grounds"]}
