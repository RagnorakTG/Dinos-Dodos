...
execute as @e[tag=find] at @s run execute as @e[tag=following,tag=!pathfinding,limit=1,sort=nearest] run tag @s add pathfinding
...
execute as @e[tag=find] at @s run execute as @e[tag=following,tag=!done,distance=..0.5] run tag @s add finished
...
execute as @e[tag=find] at @s if score @e[tag=following,limit=1,sort=furthest] pathfinding_time matches 50.. run tag @e[tag=following,limit=1,sort=nearest] add finished
execute as @e[tag=find] at @s if entity @e[tag=finished,distance=..2] run tag @e[tag=pathfinding,limit=1,tag=og,sort=nearest] add teleport
...
execute as @e[tag=teleport] at @s if entity @e[tag=find,distance=..2] run kill @e[tag=following]
