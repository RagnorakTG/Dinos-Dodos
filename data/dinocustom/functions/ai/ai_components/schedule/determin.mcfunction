...
execute as @s[tag=!aquatic,tag=crepuscular,tag=!corpse] at @s run scoreboard players set @s Active 0
# Wandering
...
# Hunting
execute as @s[tag=!aquatic,tag=herbivore,tag=dirunal,tag=!corpse,scores={Current_Happines=..60}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=herbivore,tag=nocturnal,tag=!corpse,scores={Current_Happines=..70}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=herbivore,tag=crepuscular,tag=!corpse,scores={Current_Happines=..80}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=carnivore,tag=dirunal,tag=!corpse,scores={Current_Happines=..40}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=carnivore,tag=nocturnal,tag=!corpse,scores={Current_Happines=..50}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=carnivore,tag=crepuscular,tag=!corpse,scores={Current_Happines=..60}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=piscivore,tag=dirunal,tag=!corpse,scores={Current_Happines=..45}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=piscivore,tag=nocturnal,tag=!corpse,scores={Current_Happines=..55}] run scoreboard players set @s Active 3
execute as @s[tag=!aquatic,tag=piscivore,tag=crepuscular,tag=!corpse,scores={Current_Happines=..65}] run scoreboard players set @s Active 3
