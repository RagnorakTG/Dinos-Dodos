...
execute if score @s[tag=dinosaur] Weight matches 1..5 run scoreboard players set @s Speed 3
execute if score @s[tag=dinosaur] Weight matches 6..10 run scoreboard players set @s Speed 4
execute if score @s[tag=dinosaur] Weight matches 11..15 run scoreboard players set @s Speed 5
execute if score @s[tag=dinosaur] Weight matches 16..20 run scoreboard players set @s Speed 6
execute if score @s[tag=dinosaur] Weight matches 21..30 run scoreboard players set @s Speed 7
execute if score @s[tag=dinosaur] Weight matches 31..40 run scoreboard players set @s Speed 8
execute if score @s[tag=dinosaur] Weight matches 41..50 run scoreboard players set @s Speed 9
execute if score @s[tag=dinosaur] Weight matches 51..60 run scoreboard players set @s Speed 10
execute if score @s[tag=dinosaur] Weight matches 61..70 run scoreboard players set @s Speed 9
execute if score @s[tag=dinosaur] Weight matches 71..80 run scoreboard players set @s Speed 8
execute if score @s[tag=dinosaur] Weight matches 81..90 run scoreboard players set @s Speed 7
execute if score @s[tag=dinosaur] Weight matches 91..100 run scoreboard players set @s Speed 6
