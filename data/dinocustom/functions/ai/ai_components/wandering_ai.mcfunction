...
execute as @s[tag=float] if block ^ ^0.5 ^ water run tp @s ^ ^0.3 ^ ~ -25
...
execute as @s[tag=sink] if block ^ ^-0.5 ^ water run tp @s ^ ^-0.3 ^ ~ 25
...
execute as @s[tag=walking,tag=flying,scores={Walk=60..}] if block ^ ^ ^0.9 #minecraft:move_through_heavy if block ^ ^1 ^0.9 #minecraft:move_through_heavy run tp @s ^ ^ ^0.08
execute as @s[tag=walking,tag=flying,scores={Walk=60..}] if block ^ ^1 ^0.9 #minecraft:move_through_heavy unless block ^ ^ ^0.9 #minecraft:move_through_heavy run tp @s ^ ^0.5 ^0.2
execute as @s[tag=walking,tag=flying,scores={Walk=60..}] unless block ^ ^ ^0.9 #minecraft:move_through_heavy unless block ^ ^1 ^0.9 #minecraft:move_through_heavy run tp @s ^ ^ ^-0.1 ~45 ~
