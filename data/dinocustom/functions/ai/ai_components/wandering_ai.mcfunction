...
###############
#Should Walk
execute as @s[tag=!walking,tag=terrestrial] run scoreboard players set in_0 math_rng 20
...
#Walk Time
execute as @s[tag=!walk_time,tag=terrestrial] run scoreboard players set @s Walk_time 0
execute as @s[tag=!walk_time,tag=terrestrial] run tag @s add walk_time
execute as @s[tag=!walking,tag=terrestrial,scores={Walk=1..4,Walk_time=..0}] run scoreboard players set in_0 math_rng 100
execute as @s[tag=!walking,tag=terrestrial,scores={Walk=1..4,Walk_time=..0}] run function dinocustom:ai/rng
execute as @s[tag=!walking,tag=terrestrial,scores={Walk=1..4,Walk_time=..0}] run execute store result score @s Walk_time run scoreboard players get out_0 math_rng
execute as @s[tag=!walking,tag=terrestrial,scores={Walk=1..4,Walk_time=0..}] run scoreboard players remove @s Walk_time 1
#Walk
execute as @s[tag=!walking,tag=terrestrial,scores={Walk=1..4,Walk_time=20..}] run tag @s add walking
execute as @s[tag=walking,tag=terrestrial,scores={Walk_time=20..}] if block ^ ^ ^0.9 #minecraft:move_through_heavy if block ^ ^1 ^0.9 #minecraft:move_through_heavy unless block ^ ^-1 ^0.9 water run tp @s ^ ^ ^0.3
execute as @s[tag=walking,tag=terrestrial,scores={Walk_time=20..}] if block ^ ^1 ^0.9 #minecraft:move_through_heavy unless block ^ ^ ^0.9 #minecraft:move_through_heavy run tp @s ^ ^0.5 ^0.2
execute as @s[tag=walking,tag=terrestrial,scores={Walk_time=20..}] unless block ^ ^ ^0.9 #minecraft:move_through_heavy unless block ^ ^1 ^0.9 #minecraft:move_through_heavy run tp @s ^ ^ ^ ~180 ~
execute as @s[tag=walking,tag=terrestrial,scores={Walk_time=20..}] if block ^ ^-1 ^0.9 minecraft:water run tp @s ^ ^ ^ ~90 ~
execute as @s[tag=walking,tag=terrestrial,scores={Walk_time=20..}] run tag @s remove walking
#Gravity
...
execute as @s[tag=rotate,tag=terrestrial,scores={Rotate_ammount=1}] run tp @s ~ ~ ~ ~10 ~
execute as @s[tag=rotate,tag=terrestrial,scores={Rotate_ammount=2}] run tp @s ~ ~ ~ ~-10 ~
execute as @s[tag=rotate,tag=terrestrial,scores={Rotate_ammount=3}] run tp @s ~ ~ ~ ~5 ~
execute as @s[tag=rotate,tag=terrestrial,scores={Rotate_ammount=4}] run tp @s ~ ~ ~ ~-5 ~
